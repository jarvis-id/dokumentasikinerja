...
function injectCounterWidget() {
    ...
    if (actionCard && actionCard.parentNode === container) {
        // Jika ada kartu asisten suara, letakkan di bawahnya
        actionCard.parentNode.insertBefore(widget, actionCard.nextSibling);
